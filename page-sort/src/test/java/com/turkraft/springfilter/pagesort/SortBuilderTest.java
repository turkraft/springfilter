...
class SortBuilderTest {
  ...
  void testBuildSingleFieldDefaultDirection() {
    ...
    assertEquals("name", expression
        .getFields()
        .get(0)
        .getFieldPath());
    assertEquals(SortDirection.ASC, expression
        .getFields()
        .get(0)
        .getDirection());
  }
  ...
  void testBuildSingleFieldDesc() {
    ...
    assertEquals(1, expression.size());
    assertEquals(SortDirection.DESC, expression
        .getFields()
        .get(0)
        .getDirection());
  }
  ...
  void testReusableBuilder() {
    ...
    SortExpression expression1 = builder
        .field("name")
        .desc()
        .build();
    ...
    SortExpression expression2 = builder
        .field("price")
        .asc()
        .build();
    assertEquals(1, expression2.size());
    assertEquals("price", expression2
        .getFields()
        .get(0)
        .getFieldPath());
  }
  ...
  void testNestedFieldPath() {
    ...
    assertEquals(2, expression.size());
    assertEquals("brand.name", expression
        .getFields()
        .get(0)
        .getFieldPath());
    assertEquals("owner.company.name", expression
        .getFields()
        .get(1)
        .getFieldPath());
  }
