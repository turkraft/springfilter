...
@Component
class LessThanOrEqualOperationJsonNodeProcessor extends InfixOperationJsonNodeProcessor {

  LessThanOrEqualOperationJsonNodeProcessor(JsonNodeHelper jsonNodeHelper) {
